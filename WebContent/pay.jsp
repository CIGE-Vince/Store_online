						...
						<td width="30%">
							<div align="center" style="border: 1px solid #c1eae8;">
								...
								<a id="img-link"
									...
									<img src="image/${good.gphoto}" width="115" height="115" border="0">
								</a>
									...
									<div>
										...
										<table style="padding-left: 10%">
											...
											<tr>
												...
												<button style="background-image: url(image/button1.jpg); width: 150px; height: 35px; border-style: none; 
													font-weight: bold;"><a href="success.jsp">确认无误</a></button>
												</td>
											</tr>
										</table>
									</div>
